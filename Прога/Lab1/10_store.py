...
# Для столов (код '23456') - два разных товара с разной ценой
...
# Для диванов (код '34567') - два разных товара с разной ценой
...
# Для стульев (код '45678') - три разных товара с разной ценой
